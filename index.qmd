...
keywords:
  ...
  - Quadripartite of One
  
abstract: |
  The One Health approach promotes collaboration across disciplines to enhance the health of humans, animals, plants, and the environment. Developed by the Quadripartite organizations, the One Health Joint Plan of Action (2022-2026) supports countries in implementing the One Health approach through six action tracks. However, there are currently no indicators for monitoring the implementation, state and progress of those action tracks. By requiring knowledge on One Health capacity (track 1), zoonotic diseases (tracks 2 and 3), food and agriculture (track 4), antimicrobial resistance (track 5), and environmental health (track 6), all tracks directly concern biodiversity and biologists. Our research examines the extent to which the implementation of the action tracks can be assessed by the Kunming-Montreal Global Biodiversity Framework (KM-GBF) monitoring framework of the Convention on Biological Diversity (CBD). We evaluated (1) the link between each indicator of the KM-GBF monitoring framework and human, animal, plant, and environmental health, respectively, and (2) the usability of those indicators for monitoring the action tracks. We found that 75% of the KM-GBF indicators are associated with either human (56%), animal (53%), plant (51%), or environmental (63%) health, and that 91% of them can be used for monitoring at least one action track. Reusing existing indicators can greatly improve the efficiency of monitoring systems by alleviating the financial burden associated with the development and measurement of new indicators. Our work supports collaboration between the CBD Secretariat and the Quadripartite organizations by highlighting the need and opportunities for shared data, metrics, and governance practices. 
date: last-modified
